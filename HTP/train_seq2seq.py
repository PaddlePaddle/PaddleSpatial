...
class Seq2SeqTrainer(Trainer):
    ...
    def prediction_step(
        ...
        gen_kwargs["semantic_table_ids"] = inputs['semantic_table_ids']

        gen_kwargs["hard_codes"] = inputs['hard_codes'].to(dtype=paddle.float16)
        gen_kwargs["index"] = inputs['index'].to(dtype=paddle.int64)
