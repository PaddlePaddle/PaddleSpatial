...
class DataArgument:
    ...
    table_column: str = field(default=None,metadata={"help": "The name of the column in the datasets containing the full texts (for summarization)."},)
    text_column: str = field(default=None,metadata={"help": "The name of the column in the datasets containing the summaries (for summarization)."},)
    target_column: str = field(default=None,metadata={"help": "The name of the column in the datasets containing the history of chat."},)
    hard_code_file: str = field(default=None)
    cluster_index_file: str = field(default=None)
    ...
    src_length: int = field(default=1288, metadata={"help": "The maximum length of source(context) tokens."})
